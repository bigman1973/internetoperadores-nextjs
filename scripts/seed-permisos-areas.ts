...
const areas = [
  ...
  { codigo: 'admin.crm', nombre: 'CRM', padre: 'admin', orden: 1 },
  { codigo: 'admin.clientes', nombre: 'Clientes', padre: 'admin', orden: 2 },
  { codigo: 'admin.finanzas', nombre: 'Finanzas', padre: 'admin', orden: 3 },
  { codigo: 'admin.empleados', nombre: 'Empleados', padre: 'admin', orden: 4 },
  { codigo: 'admin.tarifas', nombre: 'Tarifas', padre: 'admin', orden: 5 },
  { codigo: 'admin.leads', nombre: 'Leads', padre: 'admin', orden: 6 },
  { codigo: 'admin.facturacion', nombre: 'Facturación', padre: 'admin', orden: 7 },
  { codigo: 'admin.estadisticas', nombre: 'Estadísticas', padre: 'admin', orden: 8 },
  { codigo: 'admin.comunicados', nombre: 'Comunicados', padre: 'admin', orden: 9 },
  { codigo: 'admin.configuracion', nombre: 'Configuración', padre: 'admin', orden: 10 },
  { codigo: 'admin.usuarios', nombre: 'Usuarios', padre: 'admin', orden: 11 },
  { codigo: 'admin.historial', nombre: 'Historial', padre: 'admin', orden: 12 },
  { codigo: 'admin.proyectos', nombre: 'Proyectos', padre: 'admin', orden: 13 },
  { codigo: 'admin.contratos', nombre: 'Contratos', padre: 'admin', orden: 14 },
  { codigo: 'admin.subida_precios', nombre: 'Subida de Precios', padre: 'admin', orden: 15 },
  { codigo: 'admin.altas_pendientes', nombre: 'Altas Pendientes', padre: 'admin', orden: 16 },
