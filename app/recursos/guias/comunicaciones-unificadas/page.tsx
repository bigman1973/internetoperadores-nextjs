...
export default function GuiaComunicacionesUnificadas() {
    ...
    try {
      const response = await fetch('/api/guias-lead', {
        ...
        body: JSON.stringify({
          ...
          guia: 'Guía de Comunicaciones Unificadas'
        })
      });
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                Guía de Comunicaciones Unificadas
              </h1>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Descubra cómo unificar la telefonía, videoconferencia y mensajería de su empresa en una única plataforma para potenciar la productividad.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">Centralice todas sus comunicaciones: voz, vídeo y chat.</span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-gray-700">Reduzca costes y complejidad con una solución en la nube.</span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-gray-700">Aumente la productividad y facilite el teletrabajo.</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
              {!isSubmitted ? (
                ...
                <div className="text-center py-8">
                  ...
                  <a 
                    href="/guias/guia_comunicaciones_unificadas_2026.pdf"
                    download
