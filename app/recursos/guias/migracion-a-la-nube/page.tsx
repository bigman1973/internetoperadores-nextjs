...
export default function GuiaMigracionNube() {
    ...
    try {
      const response = await fetch('/api/guias-lead', {
        ...
        body: JSON.stringify({
          ...
          guia: 'Guía Práctica de Migración a la Nube'
        })
      });
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                Guía Práctica de Migración a la Nube
              </h1>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Los conocimientos y pasos clave para planificar y ejecutar una migración a la nube exitosa, minimizando riesgos y maximizando el retorno de la inversión.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">Convierta la inversión en hardware (CapEx) en gastos operativos (OpEx).</span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-gray-700">Acelere la innovación y el lanzamiento de nuevos productos.</span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-gray-700">Mejore la seguridad y la continuidad de su negocio.</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
              {!isSubmitted ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600 mb-6">Su guía está en camino. Revise su bandeja de entrada.</p>
                  <a 
                    href="/guias/guia_migracion_nube_2026.pdf"
                    download
