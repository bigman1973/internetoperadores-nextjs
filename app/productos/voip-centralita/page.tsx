...
export default function VoipCentralitaPage() {
  return (
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">
              VoIP y Centralita Virtual
            </h1>
            <p className="text-base sm:text-lg text-gray-300 mb-6 max-w-2xl mx-auto">
              Centralitas virtuales en la nube, SIP Trunking, integración con CRM y soluciones de comunicación profesional con Wildix y Zoom Phone.
            </p>
          </div>
        </div>
      </section>
