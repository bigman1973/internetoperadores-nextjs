...
const productos = [
  ...
  {
    id: 'voip-centralita',
    titulo: 'VoIP y Centralita Virtual',
    subtitulo: 'Telefonía IP empresarial',
    descripcion: 'Centralitas virtuales en la nube, SIP Trunking, integración con CRM y soluciones de comunicación profesional con Wildix y Zoom Phone.',
    icono: (
      <svg className="w-8 h-8 sm:w-10 sm:h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
