...
export default function FibraInternetPage() {
  return (
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="inline-block bg-orange-600/20 text-orange-400 px-3 py-1.5 rounded-full text-xs sm:text-sm font-semibold mb-4">
              Fibra dedicada y compartida
            </div>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">
              Fibra e Internet
            </h1>
            <p className="text-base sm:text-lg text-gray-300 mb-6 max-w-2xl mx-auto">
              Líneas de fibra óptica FTTH, conexiones dedicadas, backup 4G/5G y soluciones de conectividad para empresas de cualquier tamaño.
            </p>
          </div>
        </div>
      </section>
