...
export default function TelefoniaMovilPage() {
  return (
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg text-gray-300 mb-6 max-w-2xl mx-auto">
              Tarifas móviles para empresas con las mejores condiciones del mercado. Flotas, datos compartidos y gestión centralizada de líneas.
            </p>
          </div>
        </div>
      </section>
