...
import TarifaCard from '@/components/public/TarifaCard';
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
      <div className="bg-white border-2 border-gray-200 rounded-xl sm:rounded-2xl p-6 sm:p-8 hover:border-orange-500 hover:shadow-lg transition-all">
        ...
        <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
          <li className="flex items-center text-sm sm:text-base text-gray-700"><CheckIcon />Fibra 300 Mbps</li>
          <li className="flex items-center text-sm sm:text-base text-gray-700"><CheckIcon />Llamadas ilimitadas</li>
          <li className="flex items-center text-sm sm:text-base text-gray-700"><CheckIcon />Sin permanencia</li>
        </ul>
        <Link href="/contacto" className="block w-full py-2.5 sm:py-3 text-center border-2 border-orange-500 text-orange-600 rounded-lg font-semibold hover:bg-orange-50 transition-colors text-sm sm:text-base">Contratar</Link>
      </div>
      <div className="bg-orange-500 text-white rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-xl relative md:scale-105">
        <div className="absolute top-3 sm:top-4 right-3 sm:right-4 bg-white text-orange-500 px-3 py-1 rounded-full text-xs sm:text-sm font-semibold">Popular</div>
        ...
        <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
          <li className="flex items-center text-sm sm:text-base"><CheckIcon />Fibra 600 Mbps</li>
          <li className="flex items-center text-sm sm:text-base"><CheckIcon />Llamadas ilimitadas</li>
          <li className="flex items-center text-sm sm:text-base"><CheckIcon />1 línea móvil 20GB</li>
          <li className="flex items-center text-sm sm:text-base"><CheckIcon />Sin permanencia</li>
        </ul>
        <Link href="/contacto" className="block w-full py-2.5 sm:py-3 text-center bg-white text-orange-500 rounded-lg font-semibold hover:bg-orange-50 transition-colors text-sm sm:text-base">Contratar</Link>
      </div>
      <div className="bg-white border-2 border-gray-200 rounded-xl sm:rounded-2xl p-6 sm:p-8 hover:border-orange-500 hover:shadow-lg transition-all">
        ...
        <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
          <li className="flex items-center text-sm sm:text-base text-gray-700"><CheckIcon />Fibra 1 Gbps</li>
          <li className="flex items-center text-sm sm:text-base text-gray-700"><CheckIcon />Llamadas ilimitadas</li>
          <li className="flex items-center text-sm sm:text-base text-gray-700"><CheckIcon />2 líneas móvil 50GB</li>
          <li className="flex items-center text-sm sm:text-base text-gray-700"><CheckIcon />Sin permanencia</li>
        </ul>
        <Link href="/contacto" className="block w-full py-2.5 sm:py-3 text-center border-2 border-orange-500 text-orange-600 rounded-lg font-semibold hover:bg-orange-50 transition-colors text-sm sm:text-base">Contratar</Link>
      </div>
          ...
          <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
            <div className="flex items-center justify-between h-8 sm:h-10">
              <div className="flex items-center gap-3 sm:gap-4 lg:gap-6 text-xs sm:text-sm">
                <Link href="/empresa" className="text-gray-600 hover:text-orange-500 font-medium transition-colors">Empresas</Link>
              ...
              <div className="hidden sm:flex items-center gap-3 lg:gap-6 text-xs sm:text-sm">
                <Link href="/soporte" className="text-gray-600 hover:text-orange-500 font-medium transition-colors">Soporte</Link>
                <Link href="/login" className="text-gray-600 hover:text-orange-500 font-medium transition-colors">Área Cliente</Link>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
            <div className="flex items-center justify-between h-16 sm:h-20">
              ...
              <nav className="hidden md:flex items-center gap-4 lg:gap-8">
                <Link href="/internet" className="text-sm lg:text-base text-gray-700 hover:text-orange-500 font-medium transition-colors">Internet</Link>
                <Link href="/movil" className="text-sm lg:text-base text-gray-700 hover:text-orange-500 font-medium transition-colors">Móvil</Link>
                <Link href="/packs" className="text-sm lg:text-base text-gray-700 hover:text-orange-500 font-medium transition-colors">Packs</Link>
                <Link href="/ofertas" className="text-sm lg:text-base text-gray-700 hover:text-orange-500 font-medium transition-colors">Ofertas</Link>
              </nav>
              <Link href="#cobertura" className="px-3 py-2 sm:px-4 sm:py-2.5 lg:px-6 lg:py-3 bg-orange-500 text-white rounded-lg font-semibold hover:bg-orange-600 transition-all shadow-sm hover:shadow-md text-xs sm:text-sm lg:text-base">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
            <div className="order-2 md:order-1">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
                <Link href="#tarifas" className="px-6 py-3 sm:px-8 sm:py-4 bg-orange-500 text-white rounded-lg font-semibold hover:bg-orange-600 transition-colors text-base sm:text-lg text-center">
                  Ver Tarifas
                </Link>
                <Link href="tel:+34655100400" className="px-6 py-3 sm:px-8 sm:py-4 border-2 border-orange-500 text-orange-600 rounded-lg font-semibold hover:bg-orange-50 transition-colors text-base sm:text-lg text-center">
                  Llamar Ahora
                </Link>
              </div>
            </div>
          ...
          {hasDynamicTarifas ? (
            <>
              ...
              <div className="text-center mt-10">
                <Link href="/tarifas/particular" className="inline-flex items-center gap-2 text-orange-600 font-semibold hover:text-orange-700 text-lg">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
            <div>
              ...
              <ul className="space-y-2 text-sm sm:text-base text-gray-400">
                <li><Link href="/internet" className="hover:text-white transition-colors">Internet</Link></li>
                <li><Link href="/movil" className="hover:text-white transition-colors">Móvil</Link></li>
                <li><Link href="/packs" className="hover:text-white transition-colors">Packs</Link></li>
