...
export default function DemoPage() {
    ...
    try {
      const response = await fetch('/api/contacto', {
        ...
        body: JSON.stringify({
          ...
          servicio: formData.interes,
          mensaje: `Solicitud de demo | Fecha preferida: ${formData.fecha} | Horario: ${formData.horario} | ${formData.mensaje}`,
  ...
  const demos = [
    { icono: '🌐', titulo: 'Conectividad SD-WAN', desc: 'Te mostramos cómo gestionar múltiples sedes con una red inteligente que prioriza tráfico crítico y reduce costes.', duracion: '30 min' },
    { icono: '📞', titulo: 'Comunicaciones Unificadas', desc: 'Demostración en vivo de centralita virtual, integración con Teams/Zoom, grabación de llamadas y analíticas.', duracion: '30 min' },
    { icono: '📶', titulo: 'WiFi Empresarial', desc: 'Diseño de cobertura WiFi 6 para tu espacio, portal cautivo para clientes y gestión centralizada.', duracion: '20 min' },
    { icono: '🛡️', titulo: 'Seguridad de Red', desc: 'Firewall avanzado, VPN corporativa, segmentación de red y monitorización de amenazas en tiempo real.', duracion: '25 min' },
    { icono: '💾', titulo: 'ExaGrid Backup', desc: 'Solución de backup y recuperación ante desastres. Te mostramos cómo proteger tus datos críticos.', duracion: '25 min' },
    { icono: '🔧', titulo: 'Auditoría completa', desc: 'Revisión integral de tu infraestructura actual con propuesta de mejora personalizada y presupuesto.', duracion: '45 min' }
  ];
          ...
          <div className="max-w-3xl mx-auto">
            {isSubmitted ? (
              <div className="bg-green-50 border border-green-200 rounded-xl p-12 text-center">
                ...
                <p className="text-green-600 mb-6">Recibirás un email con los detalles de conexión.</p>
