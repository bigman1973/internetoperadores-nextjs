  ...
  if (!lead) {
    return (
      <div className="p-6">
        ...
        <Link href="/admin/leads-soluciones" className="text-orange-600 hover:underline mt-4 inline-block">
          Volver a leads
        </Link>
      </div>
    );
  ...
  return (
    <div className="p-4 sm:p-6 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          <Link href="/admin/leads-soluciones" className="text-sm text-gray-500 hover:text-orange-600 mb-2 inline-flex items-center gap-1">
