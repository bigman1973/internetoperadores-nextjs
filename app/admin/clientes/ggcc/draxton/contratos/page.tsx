        ...
        <div className="space-y-3">
          ...
          {datosContratos.length > 0 && (
            <div className="flex gap-2 mb-3">
              <button
                onClick={() => window.open('/api/admin/clientes/ggcc/draxton/contratos/informe-pdf?tipo=interno', '_blank')}
                className="flex items-center gap-1.5 px-3 py-1.5 bg-gray-700 text-white text-xs rounded-lg hover:bg-gray-800 transition-colors"
              >
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                Informe Interno
              </button>
              <button
                onClick={() => window.open('/api/admin/clientes/ggcc/draxton/contratos/informe-pdf?tipo=cliente', '_blank')}
                className="flex items-center gap-1.5 px-3 py-1.5 bg-orange-500 text-white text-xs rounded-lg hover:bg-orange-600 transition-colors"
              >
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                Informe Cliente
              </button>
              <button
                onClick={() => window.open('/api/admin/clientes/ggcc/draxton/contratos/informe-facturacion?anio=' + new Date().getFullYear(), '_blank')}
