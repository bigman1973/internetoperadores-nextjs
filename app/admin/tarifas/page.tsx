...
import SyncTarifasButton from '../../../components/admin/SyncTarifasButton'
...
async function getTarifas(searchParams: SearchParams) {
  ...
  const tarifasConvertidas = tarifas.map(t => ({
    ...
    velocidadBajada: t.velocidadBajada ?? null,
    velocidadSubida: t.velocidadSubida ?? null,
    fibraBajada: t.fibraBajada ?? null,
    fibraSubida: t.fibraSubida ?? null,
    datosIncluidos: t.datosIncluidos ?? null,
    minutosIncluidos: t.minutosIncluidos ?? null,
    smsIncluidos: t.smsIncluidos ?? null,
    conceptoFacturacion: t.conceptoFacturacion ?? null,
    servicioPppoe: t.servicioPppoe ?? null,
    duracionPermanenciaMeses: t.duracionPermanenciaMeses ?? null,
    observacionesPermanencia: t.observacionesPermanencia ?? null,
    noFacturar: t.noFacturar ?? false,
    noProrrateable: t.noProrrateable ?? false,
    publicarWeb: t.publicarWeb ?? false,
