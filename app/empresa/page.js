...
export default function EmpresaPage() {
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
              <div className="order-2 md:order-1">
                ...
                <Link href="/certificacion-lan" className="inline-block px-6 py-3 sm:px-8 sm:py-4 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-all font-semibold text-sm sm:text-base">
                  Solicitar Certificación LAN
                </Link>
              </div>
              <div className="bg-gray-100 rounded-xl sm:rounded-2xl p-8 sm:p-10 lg:p-12 text-center order-1 md:order-2">
                <svg className="w-24 h-24 sm:w-28 sm:h-28 lg:w-32 lg:h-32 mx-auto text-orange-600 mb-4 sm:mb-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
                <p className="text-base sm:text-lg font-semibold text-gray-900">Certificación LAN</p>
                <p className="text-sm sm:text-base text-gray-600">Garantía de rendimiento óptimo</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Partners: La solución correcta para ti - Responsive */}
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-orange-50 via-white to-orange-50">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center mb-10 sm:mb-12 lg:mb-16">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-3 sm:mb-4 px-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-6 sm:p-8 hover:shadow-xl transition-all">
              <div className="h-16 sm:h-20 flex items-center justify-center mb-4 sm:mb-6">
                <div className="text-3xl sm:text-4xl font-bold text-blue-600">Teams</div>
              </div>
      ...
      <footer className="bg-gray-900 text-white py-8 sm:py-12">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center">
            <p className="text-sm sm:text-base text-gray-400">&copy; 2026 Internet Operadores. Conectividad Total, Estés Donde Estés.</p>
          </div>
        </div>
      </footer>
    </div>
