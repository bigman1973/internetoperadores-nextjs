...
const retos = [
  { titulo: 'WiFi para huéspedes', descripcion: 'Los clientes esperan WiFi rápido y estable en todas las zonas del establecimiento.' },
  { titulo: 'Conexión 24/7', descripcion: 'Reservas online, TPVs y sistemas de gestión no pueden fallar nunca.' },
  { titulo: 'Comunicación interna', descripcion: 'Coordinación entre recepción, housekeeping, restaurante y mantenimiento.' },
  { titulo: 'Temporadas altas', descripcion: 'La infraestructura debe soportar picos de ocupación sin degradarse.' }
];

const soluciones = [
  { titulo: 'WiFi Empresarial de Alta Densidad', descripcion: 'Redes WiFi diseñadas para soportar cientos de dispositivos simultáneos. Cobertura total en habitaciones, zonas comunes, piscinas y jardines.', href: '/soluciones/infraestructura-red', caracteristicas: ['Roaming seamless', 'Portal cautivo personalizado', 'Gestión de ancho de banda', 'Analíticas de uso'] },
  { titulo: 'Conectividad con Respaldo', descripcion: 'Conexión principal de fibra con backup automático 4G/5G. Tu sistema de reservas y TPVs nunca se quedan sin conexión.', href: '/soluciones/conectividad-avanzada', caracteristicas: ['Failover automático', '99.99% disponibilidad', 'Monitorización 24/7', 'SLA garantizado'] },
  { titulo: 'Comunicaciones Unificadas', descripcion: 'Centralita virtual, extensiones móviles y chat interno para coordinar todos los departamentos del hotel.', href: '/soluciones/comunicaciones-unificadas', caracteristicas: ['Extensiones ilimitadas', 'App móvil para empleados', 'Integración con PMS', 'Grabación de llamadas'] }
];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-orange-50 via-white to-orange-50 py-10 sm:py-16 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 mb-4 sm:mb-6">Hostelería y Turismo</h1>
            <p className="text-base sm:text-lg lg:text-xl text-gray-600 mb-6 sm:mb-8 px-2">Soluciones de conectividad y comunicaciones para hoteles, restaurantes, campings y establecimientos turísticos que necesitan ofrecer la mejor experiencia a sus huéspedes.</p>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center mb-10 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-gray-600">Entendemos las necesidades específicas de la hostelería y el turismo.</p>
          </div>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-orange-600">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4 sm:mb-6 px-2">¿Quieres mejorar la experiencia de tus huéspedes?</h2>
            <p className="text-base sm:text-lg lg:text-xl text-orange-100 mb-6 sm:mb-8 px-2">Solicita una auditoría gratuita y te proponemos las mejores soluciones para tu establecimiento.</p>
