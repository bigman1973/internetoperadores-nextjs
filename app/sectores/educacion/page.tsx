...
const retos = [
  { titulo: 'Alta densidad de dispositivos', descripcion: 'Cientos de alumnos conectados simultáneamente con portátiles, tablets y móviles.' },
  { titulo: 'Aulas híbridas', descripcion: 'Combinar formación presencial con estudiantes remotos de forma fluida.' },
  { titulo: 'Seguridad y filtrado', descripcion: 'Proteger a los menores de contenidos inapropiados y amenazas online.' },
  { titulo: 'Presupuestos ajustados', descripcion: 'Maximizar el rendimiento con recursos limitados.' }
];

const soluciones = [
  { titulo: 'WiFi de Alta Densidad', descripcion: 'Redes WiFi diseñadas para soportar cientos de dispositivos simultáneos. Cobertura total en aulas, bibliotecas y zonas comunes.', href: '/soluciones/infraestructura-red', caracteristicas: ['Alta densidad', 'Roaming seamless', 'Filtrado de contenidos', 'Gestión centralizada'] },
  { titulo: 'Comunicaciones Unificadas', descripcion: 'Zoom y Teams para aulas híbridas, videoconferencias con familias y colaboración entre profesores.', href: '/soluciones/comunicaciones-unificadas', caracteristicas: ['Zoom Education', 'Microsoft Teams', 'Grabación de clases', 'Pizarras virtuales'] },
  { titulo: 'Mantenimiento IT', descripcion: 'Soporte técnico para toda la infraestructura del centro. Mantenimiento preventivo y resolución de incidencias.', href: '/soluciones/mantenimiento-it', caracteristicas: ['Soporte remoto', 'Mantenimiento preventivo', 'Gestión de equipos', 'Precio fijo'] }
];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-orange-50 via-white to-orange-50 py-10 sm:py-16 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 mb-4 sm:mb-6">Educación</h1>
            <p className="text-base sm:text-lg lg:text-xl text-gray-600 mb-6 sm:mb-8 px-2">Soluciones de conectividad, colaboración y mantenimiento IT para colegios, universidades y centros de formación.</p>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-orange-600">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4 sm:mb-6 px-2">¿Tu centro necesita mejorar su infraestructura?</h2>
            <p className="text-base sm:text-lg lg:text-xl text-orange-100 mb-6 sm:mb-8 px-2">Te ayudamos a crear el entorno tecnológico que tus alumnos y profesores necesitan.</p>
