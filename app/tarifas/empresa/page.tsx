        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex gap-6">
              <Link href="/tarifas/particular" className="text-gray-600 hover:text-gray-900">
                Particulares
              </Link>
              <Link href="/tarifas/empresa" className="text-orange-600 font-medium">
                Empresas
              </Link>
      ...
      <div className="bg-gradient-to-r from-orange-600 to-orange-500 text-white py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl opacity-90 max-w-2xl mx-auto">
            Soluciones de conectividad profesional para tu negocio. Internet, móvil y línea fija empresarial.
          </p>
        </div>
      </div>
